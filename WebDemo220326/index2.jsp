                        ...
                        <div class="card">
							...
							<!--<div class="form-group">-->
								<div class="col-sm-12 pl-0">
									<p class="text-right">
										<button name="1" class="btn btn-space btn-primary" onclick="deleteFile();">Refresh</button>
										<button name="2" class="btn btn-space btn-secondary" onclick="javascript:history.go(-1);">&nbsp;&nbsp;Back&nbsp;&nbsp;</button>
									</p>
                                </div>
								</br>
                            <!--</div>-->
