...
<%
	...
	BufferedWriter flagfile2 = new BufferedWriter(new FileWriter(web_path+"isuploaded.txt"));
	flagfile2.write("no");
	flagfile2.close();
%>
                            ...
                            <div class="card-body">
                                ...
                                <form id="validationform" data-parsley-validate="" novalidate="" method="post" action="do_index.jsp">
									...
									<div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="number" min="1" max="10" placeholder="Please enter 1 - 10, larger value ensures more accurate results, at the cost of longer running time, default = 1" class="form-control" name="mn">
                                        </div>
                                    </div>
