                            ...
                            <div class="card-body">
								<form action = "jspuploadact.jsp" method = "post" enctype = "multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 pl-0">
                                            <p class="text-right">
                                                <button type="submit" class="btn btn-space btn-primary">上传音频</button>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <form id="validationform" data-parsley-validate="" novalidate="" method="post" action="do_index.jsp">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 pl-0">
                                            <p class="text-right">
                                                <button type="submit" class="btn btn-space btn-primary">鸟声识别</button>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
							...
							<div class="form-group">
								<div class="col-sm-12 pl-0">
									<p class="text-right">
										<br>
										<button class="btn btn-space btn-primary">刷新结果</button>
									</p>
                                </div>
                            </div>
