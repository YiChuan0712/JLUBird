        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="page-section" id="overview">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <p class="lead">欢迎体验鸟声识别功能！您可以填写音频相关信息、上传音频并进行鸟声识别. 请尽量提供完整、准确的音频信息，这有助于提高鸟声识别的准确率，并会对算法的改进提供帮助.</p>
                            <ul class="list-unstyled arrow">
                                <li> 系统目前可以识别北美四地的397种鸟类. </li>
                                <li>支持 .wav 和 .ogg 格式. </li>
                                <li>填写的信息越完整，识别准确率越高，带 * 的是必填项. </li>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">音频相关信息</h5>
                            <div class="card-body">
                                <form id="validationform" data-parsley-validate="" novalidate="" method="post" action="do_index.jsp">
											...
											<div class="input-group mb-3">
                                                <script language="JavaScript">
													function myFunction() 
													{
														...
														document.getElementById("change").value = document.getElementById('upfile').value;
													}
												</script>

                                                <div class="input-group-append be-addon">
                                                    <button type="button"  class="btn btn-primary" >选择
														<input id="upfile" style="opacity:0;width:100%;height:100%;position:absolute;top:0;left:0" type="file" accept=".wav, .ogg" name="upfile" onchange="myFunction();"/>
													</button>
                                                </div>
									...
									<div class="form-group">
                                        <label class="">识别精度*</label>
                                        <div class="">
                                            <input type="number" min="1" max="10" placeholder="请输入 1 - 10，数字越大，识别精度越高，运算时间越长" class="form-control" name="mn">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label for="input-select">录制地点</label>
                                    ...
                                    <div class="form-group">
                                        <label for="input-select">录制日期</label>
