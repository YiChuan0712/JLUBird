...
# 10 frame version
filepath_list = [
     "../input/metadata_probability_v0525_2100/birdclef_resnest50_fold1_epoch_34_f1_val_04757_20210524185455.csv"
]
...
TEST_AUDIO_ROOT = Path("../input/classifier_test/")
...
candidate_df.to_csv("prob_df_make_candidates.csv", index=False)
...
candidate_df.to_csv("prob_df_add_features.csv", index=False)

# soundscapes
prob_df_soundscapes = get_prob_df(config, Path("../input/birdclef-2021/train_soundscapes"))

prob_df_soundscapes.to_csv("prob_df_soundscapes.csv", index=False)
...
candidate_df_soundscapes.to_csv("prob_df_soundscapes_make_candidates.csv", index=False)
...
candidate_df_soundscapes.to_csv("prob_df_soundscapes_add_features.csv", index=False)

exit(0)
# prob_df = pd.read_csv("prob_df.csv")
# candidate_df = pd.read_csv("prob_df_add_features.csv")
#
# prob_df_soundscapes = pd.read_csv("prob_df_soundscapes.csv")
# candidate_df_soundscapes = pd.read_csv("prob_df_soundscapes_add_features.csv")

# print(config.weights_filepath_dict.keys())
# exit(0)
