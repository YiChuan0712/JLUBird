...
def workflow_preprocess(path):
    ...
    # Bandpass Filter
    apply_bandpass_filter(signal, rate, 150, 15000, N=4)

    # Spectrogram
    flist, tlist, spec = convert_wave_to_spec(signal, rate, wlen=512, woverlap=128, nfft=512)

    # MFCC
    spec = apply_BirdNet_MFCC(spec, 150, 15000, flist, 64)

    # Magnitude transformation
    spec = apply_nonlinear_spec(spec)
...
workflow_preprocess(r"D:\birdsound\20211215\short(00-20-00-000)(00-20-05-000).wav")