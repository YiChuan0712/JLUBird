...
wav_loc = r"D:\birdsound\test211112-002300-002400.wav"
...
wav_loc = r"D:\birdsound\test211112-000000-000100.wav"
...
# wav_loc = r"D:\birdsound\after_denoising.wav"
# wavfile.write(wav_loc, 48000, output)
...
f = we.open(r"D:\birdsound\after_denoising.wav", "wb")
# 配置声道数、量化位数和取样频率
f.setnchannels(1)
f.setsampwidth(2)
